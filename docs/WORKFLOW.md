...
- [ ] `CLAUDE.md` (200 строк) грузится сам; процедуры — по skills `housepro-*`, не по памяти.
...
- [ ] `npm run check` зелёный (7 шагов: tsc → event handlers → client/server boundary → визуальный стандарт → кроны → build → test).
