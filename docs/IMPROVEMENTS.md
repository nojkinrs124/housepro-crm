...
| 2 | Нет Zod-валидации в actions | 🔴 P0 | Средняя | Безопасность + DX |
| 3 | Search uses legacy `clients` | 🔴 P0 | Низкая | Данные |
| 4 | Нет loading/error страниц | 🟠 P1 | Низкая | UX |
| 5 | Нет кэширования | 🟠 P1 | Средняя | Производительность |
| 6 | useActionState не используется | 🟠 P1 | Средняя | DX + UX |
| 7 | RLS для новых таблиц | 🟠 P1 | Низкая | Безопасность |
| 8 | Ручные типы вместо генерации | 🟡 P2 | Средняя | Надёжность |
| 9 | select('*') в листингах | 🟡 P2 | Низкая | Производительность |
| 10 | Нет GIN-индексов для поиска | 🟡 P2 | Средняя | Производительность |
| 11 | Нет env-валидации | 🟡 P2 | Низкая | DX |
| 12 | Analytics page монолит | 🟡 P2 | Средняя | Maintainability |
