...
> Source Serif 4 + Source Sans 3, плоские панели radius 10px, без теней) и **1b
...
>
> **01.09.2026 — сквозной проход по всему проекту.** Радиус, который в промежуточной
> правке уводили в 0 («Инженерный реестр»), вернули к мягким 10px направления 1c.
...
'var(--hp-radius)'        // 10px — карточки, кнопки, инпуты, иконки-боксы, панели
'var(--hp-radius-sm)'     // 6px  — вложенное: строки списка, чипы, плитки внутри карточки
...
**Правила карточек:**
- Радиус: `rounded-[var(--hp-radius)]` (10px) на контейнерах; `--hp-radius-sm` (6px) — только на вложенном (чипы, строки канбана)
...
`.hp-block` даёт скруглённую панель (радиус 10px, как у всех контейнеров в «Кабинете»);
