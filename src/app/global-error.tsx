...
export default function GlobalError({
 ...
 <div className="bg-white shadow-sm border border-gray-100 p-10 max-w-md w-full text-center space-y-6">
 ...
 <button
 onClick={reset}
 className="flex items-center gap-2 px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-medium transition-colors mx-auto"
 >
