    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-6">
          ...
          {step === 5 && (
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 rounded-xl text-sm text-muted-foreground">
          ...
          {error && (
            <div className="mt-4 px-3 py-2 bg-red-50 border border-red-100 rounded-xl text-sm text-red-600">
              {error}
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-between mt-5">
          <button
            ...
            className="px-4 py-2 text-sm text-muted-foreground border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors disabled:opacity-30"
          >
            Назад
          </button>
          ...
          <button
            onClick={handleNext}
            disabled={loading}
            className="flex items-center gap-2 px-5 py-2 bg-primary text-white rounded-xl text-sm font-medium hover:bg-primary/90 transition-colors disabled:opacity-50"
          >
