...
Аренду из такой таблицы в показания не включай. Два прибора одного вида (вода на кухне и в ванной) —
отдельные строки с title («ХВС кухня», «ГВС ванная»). Ведущие нули не значат ничего («00061,114» = 61.114);
если в цифрах нет запятой, а у соседних приборов три знака после неё — уточни у пользователя.
