export default function AnalyticsLoading() {
 ...
 <div key={i} className="bg-white p-5 border border-[var(--hp-border)] space-y-3">
 ...
 <div className="bg-white p-6 border border-[var(--hp-border)] space-y-4">
 ...
 <div key={i} className="bg-white p-6 border border-[var(--hp-border)] space-y-4">
