...
function ShowingRow({ showing }: { showing: any }) {
  return (
    <Link
      ...
      className="flex items-center justify-between gap-4 px-5 py-3.5 bg-white border border-slate-100 rounded-[16px] shadow-sm hover:shadow-md transition-all group"
    >
