...
export default async function ApiSettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {/* Docs hint */}
      <div className="flex items-start gap-3 p-4 bg-slate-50 border border-slate-100 rounded-xl text-sm">
        ...
        <div className="text-muted-foreground">
          ...
          <code className="block bg-white border border-slate-200 rounded-lg p-2 text-xs mt-2">
      ...
      <div className="space-y-2">
        {(!keys || keys.length === 0) ? (
          <div className="py-12 text-center text-muted-foreground bg-white border border-dashed border-slate-200 rounded-2xl">
