...
export default async function BillingPage({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {sp.success && (
        <div className="flex items-center gap-3 px-4 py-3 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-700 text-sm">
          ...
          {PLANS.map(plan => {
            ...
            return (
              ...
              >
                ...
                <div className={`w-9 h-9 rounded-xl ${plan.bg} flex items-center justify-center mb-4`}>
                ...
                <div className="mt-5">
                  {isCurrent ? (
                    <div className="w-full py-2 text-center text-sm font-medium text-muted-foreground bg-slate-100 rounded-xl">
                      Текущий тариф
                    </div>
                  ) : (
