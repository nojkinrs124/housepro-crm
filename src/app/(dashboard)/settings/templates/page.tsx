...
export default async function TemplatesPage() {
 ...
 icon={<FileText className="text-[var(--hp-warn)]" style={{ width: 20, height: 20 }} />}
 />
 ...
 <div className="w-14 h-14 flex items-center justify-center mx-auto mb-4 bg-[var(--hp-warn-tint)]">
 <FileText style={{ width: 22, height: 22 }} className="text-[var(--hp-warn)]" />
 </div>
 ...
 <div className="w-10 h-10 bg-[var(--hp-warn-tint)] flex items-center justify-center shrink-0">
 <FileText className="text-[var(--hp-warn)]" style={{ width: 16, height: 16 }} />
 </div>
 ...
 className="text-xs font-semibold text-[var(--hp-accent)] hover:underline px-3 py-1.5 border border-[var(--hp-border)] transition-colors hover:bg-[var(--hp-good-tint)]">
 Скачать
 </a>
 )}
 <ServerActionForm action={deleteTemplateAction.bind(null, t.id)}>
 <button type="submit"
 className="p-2 text-[var(--hp-tertiary)] hover:text-[var(--hp-danger)] hover:bg-[var(--hp-danger-tint)] transition-all duration-200">
 ...
 <div>
 <p className="text-[var(--hp-info)] text-sm font-semibold">Как использовать шаблоны</p>
 <p className="text-[var(--hp-info)] text-sm mt-1 leading-relaxed">
