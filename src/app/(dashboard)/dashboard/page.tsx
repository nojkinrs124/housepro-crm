...
export default async function DashboardPage() {
 ...
 {/* Finance */}
 <div className="bg-white border border-slate-100 p-5 h-full flex flex-col" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.04), 0 8px 24px rgba(0,0,0,0.06)' }}>
 ...
 className="flex items-center justify-between px-4 py-3 border transition-all hover:-translate-y-0.5"
 ...
 <div className="flex-1 h-8 overflow-hidden" style={{ background: '#F8FAFC' }}>
 <div
 ...
 <div
 className="p-3 border transition-all hover:-translate-y-0.5 cursor-pointer"
 style={isOverdue
 ...
 className="px-4 py-2 text-white text-sm font-bold transition-all hover:-translate-y-0.5 hover:shadow-md"
