...
export function GenerateRecurringButton() {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-[14px] text-sm font-semibold text-[#374151] hover:bg-slate-50 hover:border-slate-300 transition-all disabled:opacity-50 whitespace-nowrap"
