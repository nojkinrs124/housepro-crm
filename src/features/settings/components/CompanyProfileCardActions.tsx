...
export function CompanyProfileCardActions({ id, isDefault }: { id: string; isDefault: boolean }) {
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 border border-border text-xs font-medium text-foreground hover:bg-accent transition-all disabled:opacity-60">
