    ...
    <div className="space-y-5">
      ...
      <div className="bg-card border border-border rounded-[20px] p-6 space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          <div className="flex items-start gap-3 p-3.5 rounded-xl bg-muted/50 border border-border sm:col-span-2">
          ...
          {showLogoutConfirm ? (
            <>
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl border border-border text-sm text-foreground hover:bg-accent transition-all"
              >
                Отмена
              </button>
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-xl text-sm font-medium hover:bg-red-600 disabled:opacity-60 transition-all"
              >
                {logoutPending
            ...
            <button
              type="button"
              onClick={handleSignOutAll}
              className="flex items-center gap-2 px-4 py-2 rounded-xl border border-red-200 text-red-600 text-sm font-medium hover:bg-red-50 transition-all"
            >
