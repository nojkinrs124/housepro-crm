      ...
      <div className="bg-card border border-border rounded-[20px] p-6 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          {LEGAL_FORM_OPTIONS.map(o => (
            <label key={o.value}
              className="flex flex-col items-center gap-1.5 p-3 border border-border rounded-xl cursor-pointer hover:bg-accent transition-colors has-[:checked]:border-primary has-[:checked]:bg-primary/5 text-sm text-center">
