...
export function ProfileForm({ user }: { user: UserType }) {
 ...
 <div className="w-20 h-20 bg-primary/10 overflow-hidden flex items-center justify-center">
 {avatarSrc ? (
 ...
 value={user.email}
 disabled
 className="w-full h-10 px-4 border border-input bg-muted/50 text-sm text-muted-foreground cursor-not-allowed"
 />
 ...
 className="ml-auto flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 disabled:opacity-60 transition-all"
 >
 {profilePending
 ...
 className="ml-auto flex items-center gap-2 px-5 py-2.5 border border-border text-foreground text-sm font-medium hover:bg-accent disabled:opacity-60 transition-all"
 >
 {passwordPending
