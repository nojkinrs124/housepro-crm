...
export function AvitoFeedPanel({ feedUrl, lastSyncedAt, lastSyncError }: Props) {
  ...
  return (
    <div className="bg-white rounded-[20px] border border-slate-100 p-5 space-y-4" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.04), 0 8px 24px rgba(0,0,0,0.06)' }}>
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <input
          ...
          className="flex-1 min-w-0 h-10 px-4 rounded-xl border border-input bg-slate-50 text-foreground text-sm font-mono truncate"
        />
        <button
          onClick={copyUrl}
          className="flex items-center justify-center gap-2 px-4 py-2 border border-slate-200 rounded-[14px] text-sm font-semibold text-[#374151] hover:bg-slate-50 transition-all whitespace-nowrap shrink-0"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-2 border border-slate-200 rounded-[14px] text-sm font-semibold text-[#374151] hover:bg-slate-50 transition-all whitespace-nowrap shrink-0 disabled:opacity-60"
        >
      ...
      <div className="border-t border-slate-100 pt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="min-w-0">
          ...
          {lastSyncError && (
            <p className="text-xs text-amber-700 bg-amber-50 border border-amber-100 rounded-lg p-2 mt-2 leading-relaxed break-words">
              {lastSyncError}
            </p>
          )}
        </div>
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-[14px] text-sm font-bold text-white transition-all hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0 whitespace-nowrap shrink-0"
