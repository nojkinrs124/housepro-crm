              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {v.docx_url && (
                  <a
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 text-xs rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100 transition-colors"
                  >
                ...
                {v.version_data && (
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 text-xs rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50"
                  >
