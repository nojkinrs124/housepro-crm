 ...
 *
 * Показывается только после прокрутки первого экрана (сразу под заголовком
 * панель не нужна — там уже есть кнопка «Посчитать доход») и только до `md` —
 * на десктопе телефон виден в шапке. Наблюдаем за hero через
 * IntersectionObserver, а не за scrollY: не нужно считать высоту экрана и
 * дёргать ререндер на каждый пиксель.
 */
