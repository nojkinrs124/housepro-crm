 ...
 *
 * Живёт здесь, а не в боте: до 04.09.2026 у бота была своя копия, и в ней
 * значился статус `meeting`, которого нет ни в базе, ни в вебе. Кнопка
 * «следующий статус» записала бы его в `leads.status`, после чего лид пропал
 * бы с доски — ровно та же поломка, что разбиралась в #28.
 */
