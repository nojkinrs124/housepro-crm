 ...
 *
 * Собственник выбирает одну из трёх — и от этого зависит не только формула
 * вознаграждения, но и то, КТО НЕСЁТ РИСК ПРОСТОЯ:
 *
 *   percent      — агентство удерживает процент от платежа арендатора. Нет
 *                  арендатора — нет платежа ни собственнику, ни агентству.
 *                  Риск на собственнике.
 *   fixed        — агентство платит собственнику оговорённую сумму каждый месяц
 *                  и оставляет себе всё сверх неё. Пустой месяц агентство
 *                  оплачивает из своего кармана. Риск на агентстве.
 *   fixed_capped — агентство платит собственнику фиксированную сумму, но не
 *                  больше, чем реально поступило от арендатора. Пустой месяц —
 *                  собственник не получает ничего, а агентство не доплачивает
 *                  из своих денег. Всё, что поступило сверх фиксированной
 *                  суммы, — доход агентства.
 *
...
export const SETTLEMENT_SCHEMES: readonly SettlementSchemeConfig[] = [
  ...
  {
    value: 'fixed_capped',
    label: 'Фиксированная выплата по факту поступлений',
    description: 'Агентство платит собственнику фиксированную сумму, но не больше, чем поступило от арендатора. За пустой месяц собственник не получает ничего, а агентство не доплачивает из своих денег — сверх фиксированной суммы всё остаётся агентству.',
    vacancyRiskBearer: 'owner',
    requiredFields: ['owner_fixed_amount', 'owner_payout_day'],
    forbiddenFields: [],
  },
