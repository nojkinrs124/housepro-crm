...
export function DealsKanbanBoard({ deals: initialDeals }: { deals: any[] }) {
 ...
 <div
 key={col.status}
 className={`w-[82vw] sm:w-72 md:w-64 border-t-2 ${col.color} border border-border flex flex-col transition-colors ${isOver ? 'bg-accent/60 border-primary/30' : 'bg-card'}`}
