...
export function DealComments({ dealId, comments: initialComments, currentUserId }: Props) {
 ...
 className="opacity-0 group-hover:opacity-100 transition-opacity mt-1 p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 disabled:opacity-30"
 ...
 onChange={autoResize}
 className="flex-1 resize-none border border-border bg-background px-4 py-2.5 text-sm text-foreground placeholder:text-slate-400 focus:outline-none focus:border-[#16A34A] focus:ring-2 focus:ring-green-100 transition-all overflow-hidden"
 ...
 type="submit"
 disabled={isPending}
 className="shrink-0 w-10 h-10 bg-gradient-to-br from-[#16A34A] to-[#22C55E] text-white flex items-center justify-center hover:opacity-90 disabled:opacity-50 transition-all shadow-sm"
 >
