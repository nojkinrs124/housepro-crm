 ...
 *
 * Всё остальное — канал, расписание, рубрики, мультиагент, настройки — дело
 * владельца: там правятся промпты, по которым бот пишет в публичный канал, и
 * список тех, кто вообще имеет доступ.
 *
...
export const MEMBER_SCREENS: readonly string[] = [
  'root', 'crm', 'crm_leads', 'crm_deals', 'crm_payments', 'crm_tasks', 'help',
]
