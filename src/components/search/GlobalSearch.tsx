    ...
    >
      ...
      <div className="relative w-full max-w-xl bg-card border border-border rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="flex items-center gap-3 px-4 py-3.5 border-b border-border">
          ...
          <kbd className="hidden sm:flex items-center gap-0.5 px-1.5 py-0.5 text-xs text-muted-foreground border border-border rounded-md font-mono">
            Esc
          </kbd>
        </div>
              ...
              {QUICK_LINKS.map((link, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors ${active ? 'bg-accent' : 'hover:bg-accent/50'}`}
                  >
