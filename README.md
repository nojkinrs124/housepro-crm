...
| 🤝 **Сделки** | Kanban, комментарии, версионирование договоров, кнопка «Оформить» — договор, график начислений, задача на подписание и статус объекта одним подтверждением |
...
| 🏛 **Управление** | Объекты в доверительном управлении: договор, арендатор и общение с ним, график начислений, платежи, счётчики, задачи и печатный отчёт собственнику |
